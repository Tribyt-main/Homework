...
async def buy(call):
    product_1 = f'Название: Product{1} | Описание: описание {1} | Цена: {1 * 100}'
    product_2 = f'Название: Product{2} | Описание: описание {2} | Цена: {2 * 100}'
    product_3 = f'Название: Product{3} | Описание: описание {3} | Цена: {3 * 100}'
    product_4 = f'Название: Product{4} | Описание: описание {4} | Цена: {4 * 100}'
