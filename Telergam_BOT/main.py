...
async def buy_m(call):
    await call.message.answer(texts.game_M, reply_markup=buy_kb)
    await call.answer()

@dp.callback_query_handler(text='big')
async def buy_l(call):
    await call.message.answer(texts.game_L, reply_markup=buy_kb)
    await call.answer()

@dp.callback_query_handler(text='mega')
async def buy_xl(call):
    await call.message.answer(texts.game_XL, reply_markup=buy_kb)
    await call.answer()
